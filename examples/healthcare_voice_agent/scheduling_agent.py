...
class DoctorRecommendation(BaseModel):
    ...
    doctor_id: str = Field(description="Unique identifier for the recommended doctor")
...
class SchedulingAgent:
    ...
    def find_available_doctors(
        ...
        for doctor in self.doctors_data["doctors"]:
            ...
            if preferred_language and preferred_language not in doctor["languages"]:
                continue
    ...
    def _generate_recommendation_reason(
        ...
        next_available = datetime.strptime(doctor["next_available"], "%Y-%m-%d %H:%M")
